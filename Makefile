...
ATTR_cluster-autoscaler-1.33     := kubernetes."1.33".sigs.cluster-autoscaler
ATTR_cluster-autoscaler-1.34     := kubernetes."1.34".sigs.cluster-autoscaler
ATTR_cluster-autoscaler-1.35     := kubernetes."1.35".sigs.cluster-autoscaler
